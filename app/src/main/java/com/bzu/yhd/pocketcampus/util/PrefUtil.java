...
public final class PrefUtil {
    ...
    public static int[] getDayNightModeStartTime(Context context, boolean isDay) {
        ...
        String timeStr;
        if (isDay) {
            timeStr = SharedPrefHelper.getString(context.getString(R.string.key_day_mode_time), "8:00");
        } else {
            timeStr = SharedPrefHelper.getString(context.getString(R.string.key_night_mode_time), "18:00");
        }
